...
import FundReportsList from "../transparency/FundReportsList";
  ...
  useEffect(() => {
    const fetchNGOData = async () => {
      try {
        ...
        const response = await ngoAPI.getByOrganizationName(
        ...
        if (response && response.data) {
          setNgoData({
            id: response.data.id, // ensure we have the NGO id for passing to FundReportsList
            name: response.data.organizationName,
            image:
              response.data.imageUrl ||
              "https://www.planindia.org/wp-content/uploads/2019/08/young-helath.jpg",
            description:
            ...
            contact: {
              ...
              contactPerson:
                response.data.pointOfContactName || "Not specified",
              contactPhone:
                response.data.pointOfContactPhone || "Not specified",
            },
            socialMedia: {
    ...
    return (
      <div className="container mt-5">
        <div className="alert alert-warning">
          ...
          <p>
            You haven't set up your NGO profile yet. Please register your NGO to
            get started.
          </p>
  ...
  return (
    <div className="container mt-5">
      ...
      <>
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="mb-2">
                        ...
                        <div className="d-flex flex-wrap gap-2 mt-2">
                          {Array.isArray(ngoData.focus) ? (
                            ngoData.focus.map((area, index) => (
                              <span
                                key={index}
                    ...
                    <div className="mt-4">
                      ...
                      <div className="d-flex gap-3">
                        {ngoData.socialMedia?.facebook && (
                          <a
                            href={ngoData.socialMedia.facebook}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-decoration-none"
                          >
                        ...
                        {ngoData.socialMedia?.instagram && (
                          <a
                            href={ngoData.socialMedia.instagram}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-decoration-none"
                          >
                        ...
                        {ngoData.socialMedia?.linkedin && (
                          <a
                            href={ngoData.socialMedia.linkedin}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-decoration-none"
                          >
        ...
        {/* Insert Fund Reports List for transparency/public reports */}
        {ngoData?.id && (
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h5 className="card-title text-success">Transparency Reports</h5>
              <FundReportsList ngoId={ngoData.id} />
            </div>
          </div>
        )}
      </>
